...
const USE_CASES = {
  ...
  'battle-situation-analysis': '适合产业变局解读、政策信号与财经热点\n事件现场配战报巨字，冲突感强烈\n适合深度分析、趋势研判与重磅观点',
  'comic-perspective': '适合潮流人物、情绪表达与强观点内容\n照片混拼漫画元素，纵深冲击抢眼\n适合热点点评、年轻向选题与吸睛封面',
  'multi-panel-diary': '适合生活 Vlog、打卡记录与流程叙事\n多分镜拼接，把一件事讲成故事\n适合探店、旅行日记与步骤复盘',
  'orange-editorial': '适合深度长文、专栏观点与人物专访\n橙色巨字配黑白肖像，刊物感高级\n适合行业观察、研究报告与方法论',
  'vibrant-type-zine': '适合鲜明观点、种草分享与轻快科普\n高饱和撞色纤细巨字，时髦有主张\n适合好物推荐、生活灵感与短资讯',
  'warm-tone-notes': '适合日常记录、心情随笔与生活方式\n暖调真人场景，柔焦氛围亲切自然\n适合读书笔记、慢享日常与治愈内容'
};
